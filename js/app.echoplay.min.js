...
"use strict";var midi=null,MIDIDevices=new Object;function onMIDISuccess(e){midi=e;var i=!0,a=!1,t=void 0;try{for(var n,o=midi.inputs[Symbol.iterator]();!(i=(n=o.next()).done);i=!0){var c=n.value[1];MIDIDevices[c.id]=c,MIDIDevices[c.id].onmidimessage=function(e){if(144==e.data[0]||128==e.data[0]){var i=NoteFromMidi(e.data[1]),a=e.data[2]/127;0==e.data[2]?echoplay.interface.noteOff(i,!0):echoplay.interface.noteOn(i,!0,!1,a)}}}}catch(e){a=!0,t=e}finally{try{!i&&o.return&&o.return()}finally{if(a)throw t}}}function onMIDIFailure(e){console.log("Failed to get MIDI access - "+e)}navigator.requestMIDIAccess().then(onMIDISuccess,onMIDIFailure);