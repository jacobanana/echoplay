var AudioContextStarted=!1;$(document).ready(function(){isMobile()&&(StartAudioContext(Tone.context,$("body"),function(){}),document.ontouchmove=function(t){t.preventDefault()})});
